...
// Type: DatabaseTHP.v_ThongKeTonKhoHangHoa
...
namespace DatabaseTHP
{
    ...
    public class v_ThongKeTonKhoHangHoa : v_dm_HangHoa
    {
        public double TONGTIENCONGNODAUKY { get; set; }

        public double TONGTIENPHIEUDATHANG { get; set; }

        public double TONGTIENPHIEUXUAT { get; set; }

        public double TONGTIENPHIEUNHAPTRAHANG { get; set; }
